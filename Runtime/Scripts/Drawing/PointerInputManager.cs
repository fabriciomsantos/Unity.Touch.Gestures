...
using TouchGestures.Controls;

using UnityEngine;
using UnityEngine.InputSystem;

namespace TouchGestures.Drawing
{
    /// <summary>
    ...
    /// </summary>
    /// <remarks>
    /// <para>Couple notes about the control setup:</para>
    /// <para>
    ...
    public class PointerInputManager : MonoBehaviour
    {
        ...
        [SerializeField] private bool m_UseMouse = true;
        [SerializeField] private bool m_UsePen = true;
        [SerializeField] private bool m_UseTouch = true;
